...
def lm_checkpoint(lm_config, weight='full_sft', model=None, optimizer=None, epoch=0, step=0, wandb=None, save_dir='../checkpoints', **kwargs):
    ...
    hidden_size = getattr(lm_config, 'hidden_size', getattr(lm_config, 'dim', 0))
    ckp_path = f'{save_dir}/{weight}_{hidden_size}{moe_path}.pth'
    resume_path = f'{save_dir}/{weight}_{hidden_size}{moe_path}_resume.pth'
